# Generated by Django 2.0.2 on 2018-06-14 18:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Nombres', models.CharField(max_length=30, validators=[django.core.validators.RegexValidator(re.compile('^[\\w+\\s]+[^\\W\\d_]+$'), 'Nombre incorrecto', 'invalid')])),
                ('Cod_coordinacion', models.ForeignKey(max_length=2, on_delete=django.db.models.deletion.CASCADE, to='InscripcionPostgrado.Coordinacion')),
            ],
        ),
        migrations.CreateModel(
